...
var cancel = function (props) {
    return (React.createElement("svg", { viewBox: '0 0 64 64', height: '16px', width: '16px', role: 'img', "aria-label": 'Close', focusable: 'false' },
        React.createElement("path", { fill: props.fill || 'currentColor', d: 'M28.941,31.786L0.613,60.114c-0.787,0.787-0.787,2.062,0,2.849c0.393,0.394,0.909,0.59,1.424,0.59   c0.516,0,1.031-0.196,1.424-0.59l28.541-28.541l28.541,28.541c0.394,0.394,0.909,0.59,1.424,0.59c0.515,0,1.031-0.196,1.424-0.59   c0.787-0.787,0.787-2.062,0-2.849L35.064,31.786L63.41,3.438c0.787-0.787,0.787-2.062,0-2.849c-0.787-0.786-2.062-0.786-2.848,0   L32.003,29.15L3.441,0.59c-0.787-0.786-2.061-0.786-2.848,0c-0.787,0.787-0.787,2.062,0,2.849L28.941,31.786z' })));
};
...
var content = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { tabIndex: 1, ref: props.reference, className: wrapperClasses.join(' '), style: props.style },
            React.createElement("div", { ref: contentRef, className: classes$1.Container },
                React.createElement(Triangle, { reference: props.triangleReference }),
                props.bIsClickingDisabled ?
                    null
                    : props.bIsOpenedByClick && React.createElement("button", { onClick: props.closeTooltip, type: 'button', className: classes$1.Cancel },
                        React.createElement(cancel, null)),
                React.createElement("div", { onMouseDown: function (event) { return event.preventDefault(); }, className: classes$1.Content }, props.children)))));
};
var Triangle = function (props) {
    return (React.createElement("svg", { ref: props.reference, className: classes$1.Triangle, x: '0px', y: '0px', width: '24px', height: '24px', viewBox: '0 0 20 20' },
        React.createElement("path", { fill: 'inherit', d: 'M0,0 20,0 10,10z' }),
        React.createElement("path", { fill: 'transparent', stroke: '#E6E6E6', d: 'M0,0 10,10 20,0' })));
};

var useRef = React.useRef, useMemo = React.useMemo, useEffect$1 = React.useEffect;
...
var tooltip = function (props) {
     ...
     */
    useMemo(function () { return (React.createElement("span", { 
        /**
        ...
        */
        ...
        props.tooltip ? props.tooltip
            : React.createElement(questionMark, { fill: props.fill, background: props.background }),
        shouldRender ? (React.createElement(content, { bIsOpenedByClick: !state.bIsHidden, bIsClickingDisabled: props.shouldDisableClick, className: props.className, setTooltip: setTooltip, reference: myWrapper, contentReference: myContent, triangleReference: myTriangle, closeTooltip: closeTooltip }, props.children))
